...
<div class="row contenedor d-none d-sm-block" style="background-color: yellow;height: 370px">
	...
	<div class="col-sm-12">
		...
		<div class="row" style="height: 220px;padding:0px;">

			<div class="col-sm-6  expositor seleccionDesactivada" style="background-color: transparent;height: 100%;padding: 0px">
				<div style="background-color: white;height: 100%; margin: 0px 3px 0px 3px">
					...
					<div class="row" style="height: 90%;padding: 10px 20px 10px 20px">
						...
						<div style="width: 100%">
							<button type="button" class="btn btn-sm btn-outline-dark" style="float:right;"><i class="fas fa-newspaper"></i> Más Información</button>
						</div>
