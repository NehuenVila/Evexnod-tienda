...
<nav class="navbar navbar-expand-lg  navbar-dark navPrincipal navbar-position">
  ...
  <a  class="navbar-brand blanco-trans" href="<?php echo base_url()?>inicio/"><img style="margin-right: 10px;" src="<?php echo base_url()?>assets/img/evexnod_logo.png" alt="">Evexnod</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <a class="nav-link dropdown-toggle active" href="#" id="navbardrop" data-toggle="dropdown">Juegos</a>
      <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="#">Operation Reconquest</a>
          <a class="dropdown-item" href="#">Proyecto Asteroide</a>
        </div>
      </li>

      <li class="nav-item dropdown">
	    <a class="nav-link dropdown-toggle active" href="#" id="navbardrop" data-toggle="dropdown">Tienda</a>
	    <div class="dropdown-menu">
      ...
      <li class="nav-item dropdown">
	    <a class="nav-link dropdown-toggle active" href="#" id="navbardrop" data-toggle="dropdown">A Cerca De</a>
	    <div class="dropdown-menu">
    ...
    <ul class="ul-usuario navbar-nav ml-auto">
    	<li class="nav-item active mr-auto">
          <a class="nav-link blanco-trans" href="#">Soporte<span class="sr-only">(current)</span></a>
      </li>
    	<li class="nav-item active mr-auto">
        <a href="#" class="nav-link blanco-trans" id="perfil" >Perfil <i class="fas fa-chevron-down"></i><span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
