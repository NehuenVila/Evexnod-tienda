...
<style>
	...
	.ex{
		height: 100%;
		background-color: rgba(59, 134, 209, 0.3);
	}
	.expositor_display{
		height: 100%;
...
<div class="row contenedor d-sm-none" style="background-color: transparent;height: 420px">
	<div class="col-sm-12">	
	<h6 class="d-sm-none" style="color: white;">JUEGOS DESTACADOS:<span class="titulos"><a href="">Más información</a></span></h6>
	<br>
	<h6 class="d-sm-none" style="color: white;">EVEXNOD PREMIUM:<span class="titulos"><a href="">Más información</a></span></h6>
	<br>
	<h6 class="d-sm-none" style="color: white;">NOTICIAS:<span class="titulos"><a href="">Más información</a></span></h6>
	</div>
</div>
			...
			<div class="col-sm-3 expositor seleccionDesactivada ex">
				<div class="expositor_display">
					...
					<div class="row text-center row_JD">
						...
						<div style="height: 50%">Recorre un mundo abierto, sigilo, combate por turnos y todo tipo de items para coleccionar</div>
